...
def group_by_time_gap(activities: List[Any], gap_minutes: int = 15,
                     time_attr: str = 'timestamp_start') -> List[List[Any]]:
...
def calculate_productivity_stats(activities: List[Any], 
                                category_attr: str = 'category') -> Dict[str, float]:

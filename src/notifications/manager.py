...
from ..database.operations import get_pending_sessions, update_session_classification
...
class NotificationManager:
    ...
    def send_macos_notification(self, title: str, message: str, sound: bool = True) -> bool:
    ...
    def prompt_user_for_classification(self, session_id: int, session_name: str, 
                                     duration_min: int, confidence: int) -> Optional[Dict]:
                ...
                if "|" in response:
                    ...
                    try:
                        ...
                        if -50 <= score <= 50:
                            ...
                            classification, intensity = self._score_to_classification(score)
